  ...
  return (
    <div className="mx-auto max-w-[800px] w-full">
      ...
      <div className="flex gap-6">
        <form className="border border-gray-100 max-w-[296px] w-full p-6 rounded-[10px] h-min">
        ...
        <div className="border border-gray-100 max-w-[480px] w-full p-6 rounded-[10px] h-min">
          <div className="flex flex-col gap-1 mb-6">
