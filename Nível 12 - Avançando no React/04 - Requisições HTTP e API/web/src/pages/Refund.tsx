...
const refundSchema = z.object({
  name: z
    .string()
    .min(2, { message: "Informe um nome claro para a sua solicitação" }),
  category: z.string().min(1, { message: "Informe a categoria" }),
  amount: z.coerce
    .number({ message: "Informe um valor valído" })
    .positive({ message: "Informe um valor valído e superior a zero" }),
});
